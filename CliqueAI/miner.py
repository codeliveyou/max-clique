...
from CliqueAI.clique_algorithms import networkx_algorithm, scattering_clique_algorithm, ant_colony_algorithm
...
class Miner(BaseMinerNeuron):
    ...
    async def forward_graph(
        ...
        maximum_clique: list[int] = ant_colony_algorithm(synapse.number_of_nodes, adjacency_list)
        # or use GNN models
